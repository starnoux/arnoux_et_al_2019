...
toFold=/home/sarnoux/work/Results_July_2018_MM
toFS=/home/sarnoux/work/LD_0.4_2D_SFS
jobsscripts=/home/sarnoux/work/dadi_jobsscripts_MM
...
for i in {1..50}; do
	...
	nue="${MOD}_${i}"
	echo $nue
	mycmd="$inter ${toScript}/dadi_inference_models_arnouxv2_MM_2018.py -o ${MOD} -y Crop -x Wild -f ${toFS}/MM_HETU_order_CROP_WILD.dadi.txt  PMgl_AFS-U_WILD_CROP.HET.dadi.txt  PMgl_order_AFS-U_CROP_WILD.dadi.txt -m ${MOD} -l -p 10 20 30"
