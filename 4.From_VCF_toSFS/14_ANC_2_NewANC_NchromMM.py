...
#gff = '/data_nas1/wgs/solanaceae/Solution/starnoux/Tools/4p-master/GFF_files/SMEL_V3.2016_11_01.gff.gene'
#fin =  '/data_nas1/wgs/solanaceae/Solution/starnoux/Tools/4p-master/OUTGROUPS/tab_files/MM_MD_Consensus_OUT.RMD.tab'
#ANCin= '/data_nas1/wgs/solanaceae/Solution/starnoux/Tools/4p-master/OUTGROUPS/tab_files/MM_MD_Consensus_OUT.tab'
#temp = '/data_nas1/wgs/solanaceae/Solution/starnoux/Tools/4p-master/OUTGROUPS/tab_files/MM_MD_Consensus_OUT.temp.tab'
#with open (gff, "r+b" ) as gff, open(ANCin, 'r+b') as ANCin, open(temp, 'w') as temp:
...
#with open (ANCin, "r+b" ) as ANCin, open(temp, 'r+b') as temp, open(fin, 'w') as fin:
